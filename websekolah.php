...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning shadow-lg fixed-top">
      ...
      <img src="./image/logotp2.png" alt="Bootstrap" width="50" height="45">
    </a>
          ...
          <div class="collapse navbar-collapse text-right" id="navbarText">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="#Layanan">Jurusan </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#Portofolio">Galeri Sekolah</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#About">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#Staff">Kepala Sekolah Dan Wakil</a>
              </li>
              <li class="nav-item">
  ...
  <section class="">
  <!-- Footer -->
  <footer class="text-center text-white" style="background-color:darkorange;">
    <!-- Grid container -->
    <div class="container p-4 pb-0">
      <!-- Section: CTA -->
      <section class="">
        <p class="d-flex justify-content-center align-items-center">
          <span class="me-3">Pendaftaran PPDB</span>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2023 Copyright:
      <a class="text-white" href="https://mdbootstrap.com/">SMK TERATAI PUTIH GLOBAL II</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
